...
jQuery(document).ready(function($) {
	...
	$('#counter-1').animateNumber({ number: 2018 }, 2000 );
	$('#counter-2').animateNumber({ number: 2017 }, 2000 );
	$('#counter-3').animateNumber({ number: 2016 }, 2000 );
	},{accX: 0, accY: -200});
...
var clock;
	...
	futureDate = new Date("May 07, 2017 23:00:00")
